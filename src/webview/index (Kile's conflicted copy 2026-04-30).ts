      ...
      <div class="gsd-header-actions" role="toolbar" aria-label="Actions">
        ...
        <div class="gsd-settings-wrapper" id="settingsWrapper">
          ...
          <div class="gsd-settings-dropdown" id="settingsDropdown" role="menu" aria-label="Settings">
            ...
            <div class="gsd-settings-divider" style="display:none"></div>
            <div class="gsd-settings-section" style="display:none">
...
╚██████╔╝███████║██████╔╝
 ╚═════╝ ╚══════╝╚═════╝</pre>
    ...
    <div class="gsd-voice-recording gsd-hidden" id="voiceRecording" style="display:none">
    ...
    <div class="gsd-input-area">
      ...
      <div class="gsd-input-row">
        ...
        <button class="gsd-voice-btn gsd-hidden" id="voiceBtn" title="Record voice message" style="display:none">
